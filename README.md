[![Actions Status](https://github.com/aaronalbers/x-socket/workflows/MacOS/badge.svg)](https://github.com/aaronalbers/x-socket/actions)
[![Actions Status](https://github.com/aaronalbers/x-socket/workflows/Windows/badge.svg)](https://github.com/aaronalbers/x-socket/actions)
[![Actions Status](https://github.com/aaronalbers/x-socket/workflows/Ubuntu/badge.svg)](https://github.com/aaronalbers/x-socket/actions)
[![codecov](https://codecov.io/gh/aaronalbers/x-socket/branch/master/graph/badge.svg)](https://codecov.io/gh/aaronalbers/x-socket)
[![GitHub release (latest by date)](https://img.shields.io/github/v/release/aaronalbers/x-socket)](https://github.com/aaronalbers/x-socket/releases)
...
[GitHub](https://github.com/aaronalbers/x-socket) or
[generate a new repository from it](https://github.com/aaronalbers/x-socket/generate)
(also on **GitHub**).
...
```bash
git clone https://github.com/aaronalbers/x-socket/
```
...
[project's releases](https://github.com/aaronalbers/x-socket/releases).

## Authors

* **Filip-Ioan Dutescu** - [@aaronalbers](https://github.com/aaronalbers)
